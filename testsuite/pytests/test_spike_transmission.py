...
class TestSpikeTransmission:
    ...
    @classmethod
    def _simulate_network(cls, n_pre, n_post, conn_rule, num_threads):
        """
    ...
    def test_one_to_one(self, num_neurons, num_threads):
        """
        ...
        post_pop, spike_data = self._simulate_network(
            num_neurons, num_neurons, "one_to_one", num_threads
        )
    ...
    @pytest.mark.parametrize("num_neurons", [4, 5])
    @pytest.mark.parametrize("num_threads", THREAD_NUMBERS)
    def test_one_to_all(self, num_neurons, num_threads):
        """
        ...
        post_pop, spike_data = self._simulate_network(1, num_neurons, "all_to_all", num_threads)
        assert sorted(spike_data["senders"]) == sorted(post_pop.tolist())
        assert all(spike_data["times"] == self.t_arrival)

    @pytest.mark.parametrize("num_neurons", [4, 5])
    @pytest.mark.parametrize("num_threads", THREAD_NUMBERS)
    def test_all_to_one(self, num_neurons, num_threads):
        """
        ...
        post_pop, spike_data = self._simulate_network(num_neurons, 1, "all_to_all", num_threads)
    ...
    @pytest.mark.parametrize("num_neurons", [4, 5])
    @pytest.mark.parametrize("num_threads", THREAD_NUMBERS)
    def test_all_to_all(self, num_neurons, num_threads):
        """
        ...
        post_pop, spike_data = self._simulate_network(
            num_neurons, num_neurons, "all_to_all", num_threads
        )
