...
function( NEST_PROCESS_WITH_DEBUG )
  if ( with-debug )
    if ( with-debug STREQUAL "ON" )
      set( with-debug "-g -fno-inline -fno-omit-frame-pointer" )
    endif ()
...
function( NEST_PROCESS_WITH_LEGACY_CONN_BUILDER )
  if ( "${with-legacy-conn-builder}" STREQUAL "ON" )
    set( USE_LEGACY_CONN_BUILDER ON PARENT_SCOPE )
  else ()
    set( USE_LEGACY_CONN_BUILDER OFF PARENT_SCOPE )
  endif ()
endfunction()
