...
public:
   ...
   */
  void send( Event& e, const thread t, const double axonal_delay, const JonkeCommonProperties& cp, Node* target );
 ...
 */
inline void
jonke_synapse::send( Event& e, const thread t, const double axonal_delay, const JonkeCommonProperties& cp, Node* target )
{
