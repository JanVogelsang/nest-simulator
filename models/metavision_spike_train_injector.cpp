/*
 *  metavision_spike_train_injector.cpp
 *
...
#include "metavision_spike_train_injector.h"
...
{
void
register_metavision_spike_train_injector( const std::string& name )
{
  register_node_model< metavision_spike_train_injector >( name );
}
...
metavision_spike_train_injector::Parameters_::Parameters_()
  : spike_stamps_()
  , spike_offsets_()
...
void
metavision_spike_train_injector::Parameters_::get( DictionaryDatum& d ) const
{
...
void
metavision_spike_train_injector::Parameters_::assert_valid_spike_time_and_insert_( double t, const Time& origin, const Time& now )
{
  ...
  else
  {
    ...
    if ( not t_spike.is_grid_time() )
    {
      ...
      else
      {
        ...
        msg << "metavision_spike_train_injector: Time point " << t << " is not representable in current resolution.";
...
void
metavision_spike_train_injector::Parameters_::set( const DictionaryDatum& d,
  State_& s,
  const Time& origin,
  const Time& now,
  Node* node )
...
metavision_spike_train_injector::State_::State_()
  : position_( 0 )
{
}
...
metavision_spike_train_injector::metavision_spike_train_injector()
  : Node()
  , Device()
  , S_()
  , P_()
...
metavision_spike_train_injector::metavision_spike_train_injector( const metavision_spike_train_injector& n )
  : Node( n )
  , Device( n )
  , S_( n.S_ )
  , P_( n.P_ )
...
void
metavision_spike_train_injector::init_state_()
{
  Node::init_state_();
}

void
metavision_spike_train_injector::init_buffers_()
{
}

void
metavision_spike_train_injector::pre_run_hook()
{
...
bool
metavision_spike_train_injector::is_active( const Time& T ) const
{
...
void
metavision_spike_train_injector::update( Time const& sliceT0, const long from, const long to )
{
