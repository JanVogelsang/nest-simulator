...
class DiffusionConnection : public Connection
{
...
public:
   ...
   */
  void
  send( Event& e, const thread t, const delay dendritic_delay, const CommonSynapseProperties&, Node* target )
  {
...
void
DiffusionConnection::get_status( DictionaryDatum& d ) const
{
