...
public:
   ...
   */
  void send( Event& e, const thread t, const double Kminus, const STDPPLHomCommonProperties& );
 ...
 */
inline void
stdp_pl_synapse_hom::send( Event& e, const thread t, const double Kminus, const STDPPLHomCommonProperties& cp )
{
