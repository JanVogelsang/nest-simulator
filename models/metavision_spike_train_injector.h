...
#ifndef METAVISION_SPIKE_TRAIN_INJECTOR_H
#define METAVISION_SPIKE_TRAIN_INJECTOR_H
...
.. note::
   ...
   ``metavision_spike_train_injector`` is recommended if the spike trains have a similar
...
::
     ...
     nest.Create("metavision_spike_train_injector",
...
.. listexamples:: metavision_spike_train_injector
 ...
 */
void register_metavision_spike_train_injector( const std::string& name );

class metavision_spike_train_injector : public Node, public Device
{

public:
  metavision_spike_train_injector();
  metavision_spike_train_injector( const metavision_spike_train_injector& );
...
inline size_t
metavision_spike_train_injector::send_test_event( Node& target, size_t receptor_type, synindex, bool )
{
  SpikeEvent e;
  e.set_sender( *this );
...
inline void
metavision_spike_train_injector::get_status( DictionaryDatum& d ) const
{
  P_.get( d );
  Device::get_status( d );
}
...
inline void
metavision_spike_train_injector::set_status( const DictionaryDatum& d )
{
...
#endif // METAVISION_SPIKE_TRAIN_INJECTOR_H
