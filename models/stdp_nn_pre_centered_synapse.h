...
class stdp_nn_pre_centered_synapse : public Connection
{
 ...
 */
inline void
stdp_nn_pre_centered_synapse::send( Event& e, const thread t, const double Kminus, const CommonSynapseProperties& )
{
...
void
stdp_nn_pre_centered_synapse::get_status( DictionaryDatum& d ) const
{
...
void
stdp_nn_pre_centered_synapse::set_status( const DictionaryDatum& d, const ConnectorModel& cm )
{
