  ...
  Node* target )
{
  ...
  const double _K_value = target->get_K_value( dendritic_delay_ms, t_spike, e.get_sender_spike_data().get_syn_id() );
...
void
stdp_synapse::set_status( const DictionaryDatum& d, ConnectorModel& cm )
{
