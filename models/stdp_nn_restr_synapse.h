 ...
 */
inline void
stdp_nn_restr_synapse::send( Event& e, const thread t, const double axonal_delay, const CommonSynapseProperties&, Node* target )
{
...
void
stdp_nn_restr_synapse::set_status( const DictionaryDatum& d, ConnectorModel& cm )
{
