...
class stdp_nn_restr_synapse : public Connection
{
 ...
 */
inline void
stdp_nn_restr_synapse::send( Event& e, const thread t, const double Kminus, const CommonSynapseProperties& )
{
  ...
  //    target->get_K_values( t_spike - dendritic_delay_ms,
...
stdp_nn_restr_synapse::stdp_nn_restr_synapse()
  : ConnectionBase()
  , weight_( 1.0 )
  , tau_plus_( 20.0 )
  , lambda_( 0.01 )
...
void
stdp_nn_restr_synapse::get_status( DictionaryDatum& d ) const
{
...
void
stdp_nn_restr_synapse::set_status( const DictionaryDatum& d, const ConnectorModel& cm )
{
