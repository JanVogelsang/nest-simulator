...
#ifdef CYCLE_TIMERS
  double start_current_communicate = kernel::manager< EventDeliveryManager >.get_sw_communicate_spike_data().elapsed();
  size_t start_local_spike_counter = kernel::manager< EventDeliveryManager >.get_local_spike_counter();
#endif
...
#pragma omp master
        {
          ...
          const double end_current_communicate =
            kernel::manager< EventDeliveryManager >.get_sw_communicate_spike_data().elapsed();
          ...
          const size_t end_local_spike_counter = kernel::manager< EventDeliveryManager >.get_local_spike_counter();
