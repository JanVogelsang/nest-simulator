...
struct SpikeBufferEntry
{
  ...
  SpikeBufferEntry( const Time t_stamp, const delay axonal_delay, const synindex syn_id, const size_t local_connection_id, const delay t_syn_lag )
    : t_stamp( t_stamp )
...
inline void
DynamicSpikeBuffer::push_back( const unsigned long slices_to_postpone, const Time t_stamp,
  const delay axonal_delay, const synindex syn_id, const size_t local_connection_id, const delay t_syn_lag )
{
