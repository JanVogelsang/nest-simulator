  ...
  const ConnectorModel* cm )
{
  ...
  // TODO JV (pt): Consider sorting the regions by dendritic delay after all regions are known, and do a binary search
  //  here instead of a dictionary lookup. Requires benchmarking.
