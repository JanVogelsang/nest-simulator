...
constexpr uint8_t NUM_BITS_COMPRESSED_ID = NUM_BITS_LOCAL_NODE_ID + NUM_BITS_LOCAL_CONNECTION_ID;
...
constexpr uint64_t MAX_COMPRESSED_ID = generate_max_value( NUM_BITS_COMPRESSED_ID );
